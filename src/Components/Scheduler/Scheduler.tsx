...
type ItemModel = UpdateItemRequest | CreateItemRequest;

interface ScheduleFormProps<T extends ItemModel> {
  model: T;
  setModel: React.Dispatch<React.SetStateAction<T>>;
}

export default function ScheduleForm<T extends ItemModel>({
  model,
  setModel,
}: ScheduleFormProps<T>) {
