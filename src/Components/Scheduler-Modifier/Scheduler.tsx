...
type ModModel = UpdateModifierRequest | CreateModifierRequest;

interface ScheduleFormProps<T extends ModModel> {
  model: T;
  setModel: React.Dispatch<React.SetStateAction<T>>;
}

export default function ScheduleFormModifier<T extends ModModel>({
  model,
  setModel,
}: ScheduleFormProps<T>) {
